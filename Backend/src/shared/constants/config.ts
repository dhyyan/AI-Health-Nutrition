...
export const CONFIG = {
  ...
  BREVO_SENDER_EMAIL: process.env.BREVO_SENDER_EMAIL || process.env.SMTP_USER || 'noreply@nutriai.com',
  BREVO_SENDER_NAME: process.env.BREVO_SENDER_NAME || 'NutriAI Support',
